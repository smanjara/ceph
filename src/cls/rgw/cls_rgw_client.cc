...
int cls_rgw_bucket_unlink_instance(librados::IoCtx& io_ctx, const string& oid,
                                   ...
                                   const string& olh_tag, uint64_t olh_epoch, bool log_op, const rgw_zone_set& zones_trace, bool null_verid)
{
  librados::ObjectWriteOperation op;
  cls_rgw_bucket_unlink_instance(op, key, op_tag, olh_tag, olh_epoch, log_op, zones_trace, null_verid);
