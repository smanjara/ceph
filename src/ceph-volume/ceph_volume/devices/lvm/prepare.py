...
class Prepare(object):
    ...
    def setup_device(self, device_type, device_name, tags):
        ...
        tags['ceph.vdo'] = '1' if api.is_vdo(device_name) else '0'
    ...
    def prepare(self, args):
        ...
        if args.filestore:
            ...
            tags['ceph.vdo'] = '1' if api.is_vdo(data_lv.lv_path) else '0'
            ...
            tags['ceph.cephx_lockbox_secret'] = cephx_lockbox_secret
            tags['ceph.encrypted'] = encrypted
            tags['ceph.vdo'] = '1' if api.is_vdo(block_lv.lv_path) else '0'
