...
struct RGWCtlDef {
  ...
  int init(RGWServices& svc, rgw::sal::RGWRadosStore* store, const DoutPrefixProvider *dpp);
};
...
struct RGWCtl {
  ...
  int init(RGWServices *_svc, rgw::sal::RGWRadosStore* store, const DoutPrefixProvider *dpp);
};
