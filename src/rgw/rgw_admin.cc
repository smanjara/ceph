    ...
    do {
      ...
      for (const auto& obj : objs) {
        ...
        if (aiter == attrs.end()){
          ...
          //RGWAccessControlPolicy_S3 new_policy(g_ceph_context);
          //RGWAccessControlPolicy_S3 old_policy(g_ceph_context);
          ...
          //old_policy = static_cast<RGWAccessControlPolicy_S3>(policy);
